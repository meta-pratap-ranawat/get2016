...
public class CarDAO implements CarDaoInterface {
	...
	public int insert(CarVO carvo) {
		...
		try {
			...
			preparedStatement.setInt(4, (int)carvo.getFuelCapacity());
			preparedStatement.setInt(5, (int)carvo.getMilage());
			preparedStatement.setInt(6, (int)carvo.getPrice());
			preparedStatement.setInt(7, (int)carvo.getRoadTax());
